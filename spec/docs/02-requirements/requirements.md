...
| RF-06 | O frontmatter deve incluir um campo `modelo_llm` registrando o identificador do modelo LLM usado na geração (ex: `gpt-4o`, `claude-3.5-sonnet`, `gemini-1.5-pro`). | UQ-001 (resolvida) | Must Have | Novo requisito do stakeholder |
